class CyclicTestPressureCalculator:
    ...
    CYCLE_COUNT = [3500, 300, 600, 100, 50, 1050, 50, 3350]    

    @staticmethod
    def _get_high_pressure(design_load, index):
        return design_load * CyclicTestPressureCalculator.HIGH_PRESSURE_FACTORS[index]

    @staticmethod
    def _get_low_pressure(design_load, index):
        return design_load * CyclicTestPressureCalculator.LOW_PRESSURE_FACTORS[index]
